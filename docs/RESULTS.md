# CR-Solver — Detailed Results

All numbers below are measured on an NVIDIA RTX 4090 (24 GB). CPU baselines
are run on dual Intel Xeon Platinum 8480+ processors.

## Framework

<div align="center">
<img src="figures/framework.png" width="95%">
<p><em>Overview of the CR-Solver framework: a GPU-accelerated two-stage pipeline (parallel seed sampling / roadmap search / parallel IK, then a gradient-based refinement) that solves inverse kinematics, trajectory planning, and path following under a unified constrained optimization.</em></p>
</div>
...
<div align="center">
<img src="figures/ik_examples.png" width="80%">
<p><em>Collision-aware inverse kinematics in a cluttered lattice of spherical obstacles, for non-extendable (left) and extendable (right) robot configurations.</em></p>
</div>

## Motion Planning

<div align="center">
<img src="figures/mp_examples.png" width="80%">
<p><em>Trajectory planning in cluttered environments: (a) a random scene with spherical obstacles, and (b) a shelf scene where the trajectory traverses a narrow aisle under joint-limit and collision constraints.</em></p>
</div>
...
<div align="center">
<img src="figures/path_following.png" width="95%">
<p><em>Tracking the ICRA-shaped paths (letters I, C, R, A) while avoiding obstacles. Top: the robot traces each stroke; middle: per-letter position/rotation tracking errors; bottom: the evolution of the three driving cable lengths.</em></p>
</div>
