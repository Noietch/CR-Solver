...
from cr_solver.robots.cc_robot_extend import CCRobot as CCRobotExtend
...
def viser_main():
    ...
    ik_target_handle = server.scene.add_transform_controls(
        ...
        position=(
            ...
            0.0,
            (
                robot.config.upper_limits_length
                + robot.config.lower_limits_length
            ) / 2 * robot.config.num_sections,
        ),
        wxyz=(1, 0, 0, 0),
    )
