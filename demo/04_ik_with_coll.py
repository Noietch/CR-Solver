...
from cr_solver.geom import HalfSpace, RobotCollision, Sphere
...
def main():
    ...
    sphere_coll2 = Sphere.from_center_and_radius(
        np.array([0.0, 0.0, 0.0]), np.array([0.2])
    )
    solver = IKSolver(
        robot,
    ...
    while True:
        ...
        sphere_coll2_world_current = sphere_coll2.transform_from_pos_wxyz(
