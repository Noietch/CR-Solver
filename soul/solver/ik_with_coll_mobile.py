...
from ..costs import pose_cost, limit_cost, world_collision_cost, elastic_energy_cost, rest_base_cost

def solve_ik_with_collision_mobile(
    robot: PCCRobot,
    coll: RobotCollision,
    ...
    cfg = _solve_ik_with_collision_mobile_jax(
        robot,
        coll,
        world_coll_list,
        T_world_targets,
...
@jdc.jit
def _solve_ik_with_collision_mobile_jax(
    robot: PCCRobot,
    coll: RobotCollision,
    world_coll_list: Sequence[CollGeom],
