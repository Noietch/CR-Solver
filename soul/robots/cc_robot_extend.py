...
class CCModelConfig:
    ...
    upper_limits_length: Float[Array, "num_sections"]
    lower_limits_length: Float[Array, "num_sections"]
    ...
    def from_config(cls, config_dict: dict | str) -> CCModelConfig:
        ...
        opt_mask = (
            ...
            + [config_dict["opt_length"]] * config_dict["num_sections"]
        )
        ...
        return cls(
            ...
            upper_limits_length=jnp.array(config_dict["upper_limits_length"]),
...
class ConstantCurvatureState:
    ...
    length: Float[Array, "num_sections"]  # Length of each section
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            ...
            and jnp.allclose(self.length, other.length, atol=1e-6)
        )
    ...
    def flatten(self) -> Float[Array, "3 + num_sections + num_sections + num_sections"]:
        return jnp.concatenate([self.base_position, self.theta, self.phi, self.length])
    ...
    def repeat(self, n: int, axis: int = 0) -> ConstantCurvatureState:
        ...
        return ConstantCurvatureState(
            ...
            length=jnp.tile(
                jnp.expand_dims(self.length, axis=axis),
                make_tile_pattern(self.length.shape, axis, n),
            ),
        )
...
class CCRobot:
    ...
    def from_config(config_dict: dict) -> CCRobot:
        ...
        default_cfg = ConstantCurvatureState(
            ...
            length=jnp.ones((config.num_sections,)),
        )
        ...
        class StateVar(
            ...
            tangent_dim=3 + config.num_sections * 3,
        ): ...
