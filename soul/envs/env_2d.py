...
class Env2D:
    ...
    def _load_robot(self):
        ...
        self.robot_all_length = (
            self.robot_config["length"] * self.robot_config["num_sections"]
        )
        ...
        self.robot = PCCRobot.from_config(
            self.robot_config, default_base_position=robot_base_position
        )
    ...
    def _load_map(self):
        ...
        self.obstacles = jnp.stack(
            [self._convert_obstacle_coord(ob) for ob in self.map["obstacle_sphere"]]
        )
