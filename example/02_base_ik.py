...
from soul.visualization.visualizer_plot import visualize_pcc_model_2d, visualize_pcc_model_3d
...
def viser_main():
    ...
    ik_target_handle = server.scene.add_transform_controls(
        "/ik_target", scale=1, position=(0.0, 0.0, robot.config.length * robot.config.num_sections), wxyz=(1, 0, 0, 0)
    )
